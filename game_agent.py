...
class CustomPlayer:
    ...
    def get_move(self, game, legal_moves, time_left):
        ...
        **********************************************************************
        ...
        # Choose center move as best if available
        ...
        try:
            ...
            # Iterate for as long as possible
            depth = 1
            while True:
    ...
    def minimax(self, game, depth, maximizing_player=True):
        ...
        # If the game is already decided, return the score with no legal move
        ...
        # Base case - at the bottom of the tree: calculate score for each legal
        # move
        if depth == 1:
            return optimize([
        ...
        # Apply minimax at the next level and flip the optimizer
        # (maximizing_player)
        return optimize([
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf"), maximizing_player=True):
        ...
        for move in moves:
            ...
            if maximizing_player:
                # new best score for the max player is found
                if score > alpha:
                    alpha = score
                    best_move = move
            else:
                # new best score for the min player is found
                if score < beta:
                    beta = score
                    best_move = move
